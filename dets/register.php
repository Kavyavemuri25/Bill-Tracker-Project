...
$msg="This email  associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbluser(FullName, MobileNumber, Salary, Email,  Password) value('$fname', '$mobno', '$salary' , '$email', '$password')");
    if ($query) {
...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
	<title>Bill Tracker - Signup</title>
...
<body>
	<div class="row">
    <div class="container">
  <h1 style="font-size:30px; color:white">BILL TRACKER</h1>
    </div>
			...
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="" method="post" id="" name="signup" onsubmit="return checkpass();">
						<p style="font-size:16px; color:royalblue" align="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
						<fieldset>
              ...
              <div class="form-group">
								<input type="text" class="form-control" id="salary" name="salary" placeholder="Salary" maxlength="20" required="true">
							</div>
							<div class="form-group">
