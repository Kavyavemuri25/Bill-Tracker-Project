...
<head>
  ...
  <link href="css/stylesdash.css" rel="stylesheet">
	...
	<!--Custom Font-->
	<link href="https://fonts.googleapis.com/css?family=Constantia:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
	<!--[if lt IE 9]>
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-teal" data-percent="<?php echo $sum_monthly_expense;?>" ><span class="percent"><?php if($sum_monthly_expense==""){
echo "0";
} else {
...
$userid=$_SESSION['detsuid'];
$tmonth=date('m');
$query6=mysqli_query($con,"select sum(ExpenseCost)  as remain from tblexpense where (UserId='$userid') and (month(ExpenseDate)='$tmonth')");
$result6=mysqli_fetch_array($query6);
$query7=mysqli_query($con,"select Salary as totalamount from tbluser where Id='$userid'");
$result7=mysqli_fetch_array($query7);
$surplus_amount=$result7['totalamount']-$result6['remain'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4>Monthly Surplus Amount</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $surplus_amount;?>" ><span class="percent"><?php if($sum_total_expense==""){
echo "0";
} else {
echo $surplus_amount;
}
